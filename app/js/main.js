...
(function (app) {
    ...
    (function (scroll_1) {
        var scroll = (function () {
            function scroll($window, $location, $rootScope, $timeout) {
                var _this = this;
                this.$window = $window;
                this.$location = $location;
                this.$rootScope = $rootScope;
            ...
            scroll.factory = function () {
                var directive = function ($window, $location, $rootScope, $timeout) { return new scroll($window, $location, $rootScope, $timeout); };
